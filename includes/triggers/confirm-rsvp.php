...
class AutomatorWP_The_Events_Calendar_Confirm_RVP extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User confirms RSVP for an event', 'automatorwp-the-events-calendar' ),
            'select_option'     => __( 'User <strong>confirms RSVP</strong> for an event', 'automatorwp-the-events-calendar' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User confirms RSVP for %1$s %2$s time(s)', 'automatorwp-the-events-calendar' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User confirms RSVP for %1$s', 'automatorwp-the-events-calendar' ), '{post}' ),
            'action'            => array(
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Event:', 'automatorwp-the-events-calendar' ),
                    'option_none_label' => __( 'any event', 'automatorwp-the-events-calendar' ),
